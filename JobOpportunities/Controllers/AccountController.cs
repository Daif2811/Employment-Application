...
namespace JobOpportunities.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // drop down list     and create new list to show data from it
            // ViewBag.UserType = new SelectList(new[] { "Publisher", "Searcher" });

            // DropDownList      create list from  DataBase  by  db object     and make administrator  private or hidden  by not  this  ( !a . contains (""))
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
                    // to put users in one role   or one type    adminstrator  /  publisher  /  searcher   etc..
        ...
        public ActionResult EditProfile(EditProfileViewModel profile)
        {
            ...
            // Check the password of this user   if it == the cuurent password
